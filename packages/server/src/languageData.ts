...
const SUBCOMMAND_DEFS: [string, string[], string][] = [
	...
	["add", ["list", "mrp"], "subcommand.add.description"],
	["a", ["mrp"], "subcommand.a.description"],
	["remove", ["list"], "subcommand.remove.description"],
	["restore", ["verm", "mrp"], "subcommand.restore.description"],
	["r", ["verm", "mrp"], "subcommand.r.description"],
	["serialize", ["verm", "mrp"], "subcommand.serialize.description"],
	["s", ["verm", "mrp"], "subcommand.s.description"],
	["export", ["verm", "mrp"], "subcommand.export.description"],
	["e", ["verm", "mrp"], "subcommand.e.description"],
	["update", ["verm", "mrp"], "subcommand.update.description"],
	["u", ["verm", "mrp"], "subcommand.u.description"],
	["lock", ["verm", "mrp"], "subcommand.lock.description"],
	["unlock", ["verm", "mrp"], "subcommand.unlock.description"],
	["clean", ["verm", "mrp"], "subcommand.clean.description"],
